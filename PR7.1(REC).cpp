...
void Sort(int** z, const int rowCount, const int colCount)
{
	for (int i0 = 0; i0 < rowCount - 1; i0++)
	{
		...
		{
			// —ортуванн€ за спаданн€м елемент≥в першого стовпц€
			if (z[i1][0] < z[i1 + 1][0] ||
				// якщо елементи першого стовпц€ р≥вн≥, сортуЇмо за спаданн€м другого стовпц€
				(z[i1][0] == z[i1 + 1][0] && z[i1][1] < z[i1 + 1][1]) ||
				// якщо елементи першого ≥ другого стовпц≥в р≥вн≥, сортуЇмо за спаданн€м третього стовпц€
